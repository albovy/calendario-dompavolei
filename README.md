...
página, el `.ics`, un Excel y un `.ics` por equipo, además de `salidas.html`: la página con el diseño nuevo (plantilla `src/plantilla-salidas.html`, los mismos datos y el escudo del club, `escudo.png`). La tarea `.github/workflows/calendario.yml`
